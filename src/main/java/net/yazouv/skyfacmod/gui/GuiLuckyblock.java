...
package net.yazouv.skyfacmod.gui;

import org.lwjgl.opengl.GL11;
import org.lwjgl.input.Keyboard;

import net.yazouv.skyfacmod.procedure.ProcedureGiveaways;
...
public class GuiLuckyblock extends ElementsSkyfacmodMod.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiLuckyblock(ElementsSkyfacmodMod instance) {
		super(instance, 2);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				SkyfacmodMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("skyfacmod:textures/luckyblock.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Sky Lucky Block", 31, 9, -256);
		}
		...
		public void initGui() {
			super.initGui();
			this.guiLeft = (this.width - 138) / 2;
			this.guiTop = (this.height - 102) / 2;
			Keyboard.enableRepeatEvents(true);
			this.buttonList.clear();
			this.buttonList.add(new GuiButton(0, this.guiLeft + 38, this.guiTop + 31, 60, 20, "OUVRIR "));
		}

		@Override
		protected void actionPerformed(GuiButton button) {
			SkyfacmodMod.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
		...
		if (buttonID == 0) {
			{
				...
				ProcedureGiveaways.executeProcedure($_dependencies);
			}
		}
	}
